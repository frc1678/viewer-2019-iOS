    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if TIMD.teamNumber != nil && TIMD.matchNumber != nil {
            ...
            if key.contains("calculatedData") {
                ...
                value = (TIMD.calculatedData!.dictionaryRepresentation() as NSDictionary).object(forKey: key.replacingOccurrences(of: "calculatedData.", with: ""))
            } else {
            ...
            if value != nil {
                ...
                if value is String {
                    ...
                    if stringValue == "cargo" || stringValue == "lemon" {
                        stringValue = ["cargo":"Cargo","lemon":"Panel"][stringValue]!
                    }
